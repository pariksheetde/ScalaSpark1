...
object FIFA_Stats_1 {
  println("FIFA World Cup Analysis 1")

  val sparkAppConfig = new SparkConf()

  sparkAppConfig.set("spark.app.name", "FIFA World Cup Analysis 1")
  ...
  def main(args: Array[String]): Unit = {
    ...
    all_fifa_cln_up.show(false)
    println(s"Rows effected: ${all_fifa_cln_up.count()}")
    spark.stop()
  }
